...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePerformance() {
        ...
        setTimeout(() => {
            ...
            // Added img-fluid class for responsiveness in light mode container if needed
            playerFrame.innerHTML = `<img src="${currentPerformance.image}" class="img-fluid" alt="${currentPerformance.title}" style="width:100%; height:100%; object-fit:cover;">`;
    ...
    playerFrame.innerHTML = `<img src="${firstPerformance.image}" class="img-fluid" alt="${firstPerformance.title}" style="width:100%; height:100%; object-fit:cover;">`;
});
